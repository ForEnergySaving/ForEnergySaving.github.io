window.onload = function () {
    ...
    const contentArr = [
      ...
      },
      {
        ...
        question:'1日1時間、パソコン使用時間を減らした場合の省エネ効果（年間）を知っていますか？',
        flip1: 'デスクトップ型',
      ...
      },
      {
        ...
        question:  '冷蔵庫にまつわる省エネ行動や効果を知っていますか？',
        flip1: 'ものを詰め込みすぎない',
      ...
      },
      {
        ...
        question:'1日1時間、点灯時間を減らした場合の省エネ効果（年間）を知っていますか？',
        flip1: '白熱電球（54W）',
      ...
      },
      {
        ...
        question:'毎日1時間早くエアコンを切る場合の省エネ効果（年間）を知っていますか？',
        flip1: '冷房（設定温度28℃）',
